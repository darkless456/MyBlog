 ...
 * @Last Modified time: 2016-01-20 21:15:53
*/
...
while($get_all = mysql_fetch_array($select_all)){
    ...
    if(strlen($opt_str) >= 300){
        $essay_opt = mb_substr($opt_str, 0, 300, 'utf-8'). '<br/><a class="readmore" target="_blank" href="'.$show_dir.'handle_essay.php?action=show&'.$id_type.'='. $get_all[$id_type]. '">...read more</a><br/>';
