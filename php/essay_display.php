 ...
 * @Last Modified time: 2016-01-20 21:38:07
*/
...
while($get_all = mysql_fetch_array($select_all)){
    ...
    if(strlen($opt_str) >= 400){
        $essay_opt = mb_substr(html_entity_decode($opt_str), 0, 300, 'utf-8'). '<br><a class="readmore" target="_blank" href="'.$show_dir.'handle_essay.php?action=show&'.$id_type.'='. $get_all[$id_type]. '">...read more</a><br>';
