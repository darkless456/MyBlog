...
$(document).ready(function() {
    ...
    // oUl_Img_Scroll.click(function() {
    //     clearInterval(JS.timer);
    // })
    // oUl_Img_Scroll.mouseout(function() {
    //     JS.timer = setInterval(function() {
    //         if (JS.oUl_Img_Scroll.offsetLeft < -JS.oUl_Img_Scroll.offsetWidth / 2) {
    //             JS.oUl_Img_Scroll.style.left = 0 + "px";
    //         } else {
    ...
    // -------------------------------PY-----------------------------------------//
    //content part
    $(".beginner .content_txt:first").load("../txt/txt_py/beginner.txt");
    $(".history .content_txt:first").load("../txt/txt_py/history.txt");
    $(".features .content_txt:first").load("../txt/txt_py/features.txt");
